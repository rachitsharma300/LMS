...
export default function CourseCard({ 
  ...
  // Default course data to prevent errors
  const {
    id,
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-200 overflow-hidden transition-all duration-300 transform hover:-translate-y-2">
      ...
      <div className="relative overflow-hidden bg-gray-100">
        ...
        {/* Course Level Badge */}
        <div className={`absolute top-3 left-3 px-2 py-1 rounded-full text-xs font-medium ${getLevelColor(level)}`}>
          {level}
        </div>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">{totalStudents.toLocaleString()} students</div>
          </div>
        </div>
