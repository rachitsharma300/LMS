...
export default function UserManagement() {
  ...
  const getRoleBadgeColor = (role) => {
    switch (role) {
      case 'ROLE_ADMIN': return 'bg-red-100 text-red-800 border-red-200';
      case 'ROLE_INSTRUCTOR': return 'bg-blue-100 text-blue-800 border-blue-200';
      case 'ROLE_STUDENT': return 'bg-green-100 text-green-800 border-green-200';
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage user roles and system access</p>
          </div>
        </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {editingUser === user.id ? (
                        ...
                        <div className="flex items-center space-x-3">
                          <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getRoleBadgeColor(user.role?.name)}`}>
